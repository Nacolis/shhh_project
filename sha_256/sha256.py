...
# ATTENTION PAS FINIT AU NIVEAU DES COMMENTAIRES # 
...
# Hash  avec l'algo de base
custom_hash = sha256(message)

# Hash avec la bibliothèque standard
standard_hash = hashlib.sha256(message.encode()).hexdigest()

### TEST et comparaison des deux ###
print(f"Votre hash:    {custom_hash}")
print(f"Hash standard: {standard_hash}")
